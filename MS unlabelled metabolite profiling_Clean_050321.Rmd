...
MS_Int <- read_excel('/Users/leesh/Documents/MS analysis pipeline/Nate test plot size in R markdown/NK801_Metabolite_Intensities.xlsx')
...
Welch_ttest  <- sapply(dataNamed_HC[3:177], 'Welch_ttest')
...
Welch_ttest  <- sapply(dataNamed[3:1055], 'Welch_ttest')
